...
and process variations during manufacture. A PUF extracts these differences by a 
...
They are typically used to digitalize real world signals from sensors, which
then can be processed. Mixed signal circuits are also used to control hardware
devices. For instance, in a mobile phone, audio signals captured from 
